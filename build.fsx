...
let project = "FunkyTasks"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Functional combinators for System.Threading.Tasks"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "This library provides functional combinators for the System.Threading.Task monad including full support for the LINQ query syntax."

// List of author names (for NuGet package)
let authors = [ "Stefan Reichel" ]

// Tags for your project (for NuGet package)
let tags = "task async linq parallel concurrent"

// File system information 
let solutionFile  = "FunkyTasks.sln"
